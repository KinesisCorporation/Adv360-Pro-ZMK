...
#define KC_TASKMAN  LALT(LCTL(KC_DEL))
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  DE_Y,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_PSCR,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_A,KC_LALT,KC_LCTRL,KC_LOWER, KC_ENT,      KC_SPC,  KC_RAISE, KC_RCTRL, KC_RALT, KC_RGUI
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
[_LOWER] = LAYOUT(
   DE_TILD,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
   DE_QUOT,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_F12,
  _______, DE_EXLM,   DE_AT, DE_HASH,  DE_DLR, DE_PERC,                       DE_GRV, DE_AMPR, DE_ASTR, DE_LPRN, DE_RPRN, DE_PIPE,
  _______,  DE_EQL, DE_MINS, DE_PLUS, DE_LCBR, DE_RCBR, _______,       _______, DE_LBRC, DE_RBRC, DE_LABK, DE_RABK, DE_BSLS, _______,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      | KC_P4| KC_P5| KC_P6|COLEMAK|                    |     | REC1 | RSTP | PLY1 |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      | KC_P1| KC_P2| KC_P3|QWERTY|-------.    ,-------|      | VOLDO| MUTE | VOLUP|      |      |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |      |      | KC_P0|      |      |MACWIN|-------|    |-------|      | PREV | PLAY | NEXT |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
  [_ADJUST] = LAYOUT(
  XXXXXXX, XXXXXXX, KC_7, KC_8, KC_9, RESET,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, KC_4, KC_5, KC_6, KC_COLEMAK,                     XXXXXXX, DM_REC1, DM_RSTP, DM_PLY1, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, KC_1, KC_2, KC_3, KC_QWERTY,                     XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, KC_0, XXXXXXX, XXXXXXX, CG_TOGG, XXXXXXX,     XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
                   _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______
  )
};
...
static void render_logo(void) {
    static const char PROGMEM hell_logo[] = {};
...
static void print_status_narrow(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case _QWERTY:
            ...
            pimoroni_trackball_set_rgbw(200,89,88,0);
            break;
        case _RAISE:
            oled_write("Raise", false);
            pimoroni_trackball_set_rgbw(102,204,0,0);
            break;
        case _LOWER:
            oled_write("Lower", false);
            pimoroni_trackball_set_rgbw(43,0,255,0);
            break;
        case _ADJUST:
...
void matrix_scan_user(void) {
  LEADER_DICTIONARY() {
    ...
    SEQ_ONE_KEY(KC_S) {
      ...
      SEND_STRING("Jan Georgens");
    }
    SEQ_ONE_KEY(KC_M) {
      // Anything you can do in a macro.
      SEND_STRING("jan.georgens@essentry.com");
    }
    SEQ_ONE_KEY(KC_R) {
      // Anything you can do in a macro.
